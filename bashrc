...
export HISTIGNORE='[a-z]:history:pwd:rm:ls:cd:sensors:top:btm:uptime:uptime -p'
...
export NNN_OPTS='cEA'
export NNN_PLUG='t:lstar;T:trash;m:mediainf;i:imgview;c:cpb;C:cpp;v:video;e:extract;p:spv'
